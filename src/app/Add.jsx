    ...
    <>
      {showModal ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-blue focus:outline-none">
          <div className="flex flex-col items-center rounded-3xl p-4 bg-my-light-blue border-8 border-my-blue border-double">
            <div className="relative flex flex-col w-full outline-none focus:outline-none">
              <div className="flex flex-row items-center justify-between p-2 border-solid rounded-xl bg-my-blue">
                <h3 className="text-3xl font-mono font-extrabold text-white font-outline-2">
                  Add Expense
                </h3>
                {/* <button
              ...
              <form className="m-4 flex flex-col items-center">
                <label className="p-2 font-mono text-2xl font-bold font-outline-2">Title</label>
                <input type="text" className="rounded-xl focus:outline-my-blue"></input>
                <label className="p-2 font-mono text-2xl font-bold font-outline-2 focus:outline-my-blue">Paid by</label>
                <input type="text" className="rounded-xl"></input>
                <label className="p-2 font-mono text-2xl font-bold font-outline-2 focus:outline-my-blue">Split Between</label>
                <input type="text" className="rounded-xl"></input>
              </form>
            </div>
          </div>
