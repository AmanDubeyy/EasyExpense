    ...
    <>
      {showModal ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-blue focus:outline-none bg-my-light-blue">
          <div className="flex flex-col items-center rounded-3xl p-4 bg-my-light-blue border-8 border-white ">
            <div className="relative flex flex-col w-full outline-none focus:outline-none">
              ...
              <form className="m-4 flex flex-col items-center">
                <label className="p-2 font-mono text-2xl font-bold font-outline-white-2 text-my-blue">Title</label>
                <input type="text" className="rounded-xl focus:outline-my-blue"></input>
                <label className="p-2 font-mono text-2xl font-bold font-outline-white-2 text-my-blue">Paid by</label>
                <input type="text" className="rounded-xl focus:outline-my-blue"></input>
                <label className="p-2 font-mono text-2xl font-bold font-outline-white-2 text-my-blue">Split Between</label>
                <input type="text" className="rounded-xl focus:outline-my-blue"></input>
              </form>
            </div>
          </div>
